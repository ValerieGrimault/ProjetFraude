...
df=st.cache(pd.read_csv)('DatasetMachineLearning.csv')
...
clf=['Extra Trees','Random Forest', 'XGboost']
...
if st.sidebar.checkbox('Run a fraud detection model'):
    
    alg=['Extra Trees','Random Forest','XGboost','Support Vector Machine','Logistic Regression']
